...
ContextMenu.prototype.onAdd=function() {
	function createMenuItem(values){
		...
		menuItem.onclick = function () {
		    google.maps.event.trigger($this, 'menu_item_selected', $this.position_, values.eventName, $this.marker, $this.device, $this.source);
	...
	function createMenuSeparator(){
		var menuSeparator=document.createElement('li');
 ...
 */
ContextMenu.prototype.show = function (latLng, marker, device, source) {
