...
public class OrmDbHelper extends SQLiteAssetHelper {
    ...
    public static final String DATABASE_NAME = "iPayment.db";
    ...
    private Dao<TransactionModel, Integer> mTransactionDao = null;
    private Dao<TransactionItemModel, Integer> mTransactionItemDao = null;
...
//    }
    ...
    public void close() {
        ...
        mTransactionDao = null;
        mTransactionItemDao = null;
    }
    ...
    public Dao<TransactionModel, Integer> getTransactionDao() throws SQLException {
        if (mTransactionDao == null) {
            mTransactionDao = getDao(TransactionModel.class);
        }
        return mTransactionDao;
    }

    public Dao<TransactionItemModel, Integer> getTransactionItemDao() throws SQLException {
         if (mTransactionItemDao == null) {
            mTransactionItemDao = getDao(TransactionItemModel.class);
        }
        return mTransactionItemDao;
    }
