...
//            new ToggleGPS(getApplicationContext()).turnGPSOn();
            ...
            mGpsInterval = intent.getIntExtra(Constants.GPS_INTERVAL, 60000);
            mLocationManager = (LocationManager) getApplicationContext().getSystemService(Context.LOCATION_SERVICE);
            mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, mGpsInterval, 1, mLocationListener);
    ...
    private LocationListener mLocationListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            //LocalBroadcastManager.getInstance(LibApp.getContext()).sendBroadcast(locationIntent);
            //MessageManager.showMessage(String.format("GPS 1: %f: %f", location.getLatitude(), location.getLongitude()), ErrorSeverity.None);
